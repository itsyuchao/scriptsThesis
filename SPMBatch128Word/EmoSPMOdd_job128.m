...
for i = 1:60 
    spm_mkdir([rootDir '/S' num2str(i, '%02.f') '/SPMemoOutputs128']);
end

%%BATCH RUN
for i = 1:60 
    outDirSPM = [rootDir '/S' num2str(i, '%02.f') '/SPMemoOutputs128'];
...
%%
matlabbatch{1}.spm.stats.fmri_spec.sess(1).cond.pmod.param = [1.777777778
                                                              1.814814815
                                                              1.703703704
                                                              1.555555556
                                                              1.814814815
...
%%
matlabbatch{1}.spm.stats.fmri_spec.sess(2).cond.pmod.param = [1.814814815
                                                              2
                                                              2.296296296
                                                              2.259259259
                                                              2.333333333
